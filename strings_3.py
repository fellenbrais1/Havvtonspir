...
# We can use a 'for' loop to iterate through the characters in the 'number' variable
...
# We have to first initialize separators before we add to it later otherwise there could be issues
separators = ""
