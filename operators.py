...
# This code would work as integer division returns an int which can be used in a range
for i in range(1, a // b):
    print(i)
...
# Change the order you want an equation to run in by adding or removing parentheses
print(a + b / 3 - 4 * 12)
print(a + (b / 3) - (4 * 12))
print((((a + b) / 3) - 4) * 12)
print(((a + b) / 3 - 4) * 12)
