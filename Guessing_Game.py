...
def guesser():
    # The 'highest' variable allows us to specify what the game plays between e.g. between 1 and 'highest'
    highest = 10
    ...
    print("You must guess a number between 1 and {1}, you have {0} guesses \nGood luck!".format(guess_count, highest))
        ...
        if guess_count == 0:
            ...
            try:
                ...
                if 0 < guess < highest + 1:
                    ...
                    print("I'm sorry, please enter a number between 1 and {0} to proceed".format(highest))
