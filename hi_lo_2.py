...
# This version allows the program to say what the correct guess is when it closes in on it
...
def hi_lo():
    ...
    while low != high:
        ...
        while guess_loop:
            ...
            if user_input == 'c':
                if guess_count == 1:
                    print("Ah! So the answer IS {0}!".format(guess))
        ...
        if guess_count == 1:
            print("Ah! The answer is {0}!".format(high))
            print("\nI got the answer correct on my first guess!")
            exit()
        elif guess_count == 10:
            print("Ah! The answer is {0}!".format(high))
