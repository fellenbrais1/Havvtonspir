...
try:
    ...
    exit()
    # This has to be put here to keep the IDE happy but really the next line of code is unreachable
    from story_of_you import story_of_you

# This code is to specify values to be used by the 'story_of_you' function instead of the default ones
input_name = "Michael"
input_age = "35"
