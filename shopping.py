...
# Most people will do this as the 'continue' key word isn't actually used that much
print()
...
# 'continue' makes all the remaining code in that iteration of the loop to be skipped
print()
for item in shopping_list:
    if item == 'spam':
        continue
