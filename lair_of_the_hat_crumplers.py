...
# There is a lot of duplicate code for characters 1-3 \
...
char_list = char_1_name + ", the mighty and incomparable " + \
            char_1_class + ",\n" + char_2_name + \
            ", the most formidable " + char_2_class + \
            " this world has ever seen, and,\n" + char_3_name \
            + ", the most deadly " + char_3_class + \
...
if char_1_class == char_class[0] or char_2_class == char_class[0]\
        or char_3_class == char_class[0]:
    ...
    print(
        "Good gracious! Without a Crimper present, the hat-crumpling trap "
