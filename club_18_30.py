...
while not done:
    try:
        ...
        if 17 < age <= 30:
            ...
            print("\nI am sorry but at age {2} you are too young to join us "
                  "on an 18-30 holiday!\nPlease come back in {0} years {1}!"
                  .format(18 - age, name, age))
            done = True
        else:
            print("\nI am sorry, but at {0} years old, you have missed your"
                  "chance to join us on an 18-30 holiday!".format(age))
